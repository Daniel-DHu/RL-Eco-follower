...
class SAC:
    ...
    def save(self, episode):
        torch.save(self.actor.state_dict(), "./model/MBPO/mbpo_s9_actor{}.pth".format(episode))
...
for run in [base_name]:
    ...
    mbpo = MBPO(env, sac, fake_env, env_pool, model_pool, rollout_length,
    ...
    # save results
    result.append(
        [episode_score, rolling_score, cum_collision_num, score_safe, score_efficiency, score_comfort, score_energy])
